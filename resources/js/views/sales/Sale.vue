    ...
    <section class="main-content" v-else>
        <div class="columns">
            <div class="column is-6 is-offset-6 has-text-right-desktop has-text-centered-mobile">
                ...
                <button class="button is-primary has-icon-left" @click="editSale">
        ...
        <div class="box">
                ...
                <div class="column is-8">
                    <div class="has-text-dark">
                        ...
                        <h6 class="subtitle is-6">
                            ...
                            {{ sale.customer.contact_phone }}
                        </h6>
                        <h6 class="subtitle is-6 has-text-weight-bold">
                            {{ sale.customer.id_type.name + '# ' + sale.customer.identification }}
                        </h6>
                    </div>
                </div>
                <div class="column is-4">
                    <h5 class="subtitle is-5 is-pulled-right">
                        Invoice Number: {{ sale.bill_number }}<br/>
                        Invoice Date: {{ dayjs(sale.bill_date).format("DD-MM-YYYY") }}
                    </h5>
                </div>
            </div>
            <b-table :data="sale.items" bordered>
            ...
            <div class="columns">
                <div class="column is-3 is-offset-9">
                    <b-table bordered :data="saleData" :columns="saleDataColumns" :show-header="false" narrowed></b-table>
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            downloadInvoice() {
                window.open('/api/v1/sales/' + this.sale.id + '/invoice', '_blank')
            },
