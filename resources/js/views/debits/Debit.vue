            ...
            getDebit() {
                ...
                axios.get('/api/v1/debits/' + this.debit.id).then(response => {
                    ...
                    this.debitData = [
                        {
                            name: "SubTotal",
                            value: '{{ currencySymbol }}' + this.debit.sub_total
                        },
                        {
                            name: "Discount",
                            value: '{{ currencySymbol }}' + this.debit.discount
                        },
                        {
                            name: "Tax",
                            value: '{{ currencySymbol }}' + this.debit.tax
                        },
                        {
                            name: "Round Off",
                            value: '{{ currencySymbol }}' + (this.debit.total - Math.floor(this.debit.total)).toFixed(2)
                        },
                        {
                            name: "Total",
                            value: '{{ currencySymbol }}' + Math.round(this.debit.total)
                        }
                    ]
